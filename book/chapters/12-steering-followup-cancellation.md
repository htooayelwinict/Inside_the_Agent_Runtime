...
Lab က deque နှစ်ခုထဲ Message တစ်ခုစီထည့်ပြီး steering ကို `turn_end` မတိုင်ခင်၊ follow-up ကို `turn_end` နောက်မှာ drain လုပ်ပြပါတယ်။ `drain_one()` က တစ်ကြိမ်မှာ Message တစ်ခုသာယူလို့ boundary ကို output ကနေ လွယ်လွယ်မြင်နိုင်ပါတယ်။ ဒီ example က queue drain placement ကိုသာ model လုပ်ထားတာပါ။

ဒါက production Agent Loop မဟုတ်ပါဘူး။ Live provider cancellation၊ threads၊ concurrent arrival၊ Tool Call execution၊ RunLease ownership သို့မဟုတ် network timing ကို မ simulate လုပ်ပါဘူး။ Output လေးကြောင်းမှန်တာက steering/follow-up placement သင်ခန်းစာကိုသာ စစ်ပေးပြီး production cancellation အလုပ်မှန်ကြောင်း မသက်သေပြပါဘူး။
