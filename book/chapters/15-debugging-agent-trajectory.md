...
```bash
python3.13 examples/lewis_trace_reader.py
```
...
```bash
python3.13 -m unittest tests.test_lewis_workshop.TraceReaderTests.test_completion_and_result_order_are_reported_separately -v
```
